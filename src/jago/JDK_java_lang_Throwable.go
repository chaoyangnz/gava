...
func register_java_lang_Throwable() {
	register("java/lang/Throwable.getStackTraceDepth()I", JDK_jang_lang_Throwable_getStackTraceDepth)
	register("java/lang/Throwable.fillInStackTrace(I)Ljava/lang/Throwable;", JDK_jang_lang_Throwable_fillInStackTrace)
	//register("java/lang/Throwable.getStackTraceElement(I)Ljava/lang/StackTraceElement;", JDK_jang_lang_Throwable_getStackTraceElement)
}
...
func JDK_jang_lang_Throwable_fillInStackTrace(this Reference, dummy Int) Reference {
	...
	//	backtrace.SetElement(Int(depth-1-i), str)
	//}
	//
