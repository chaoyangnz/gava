 ...
 */
func (this *API) InvokeMethod(method *Method, params ... Value) Value {
...
func (this *API) CurrentThread() *Thread {
	return VM.current()
}
...
func (this *API) SetInstanceVariable(objref ObjectRef, name string, descriptor string, value Value)  {
	objref.SetInstanceVariableByName(name, descriptor, value)
}

func (this *API) GetStaticVariable(class *Class, name string, descriptor string) Value {
...
func (this *API) SetStaticVariable(class *Class, name string, descriptor string, value Value)  {
	field := class.FindField(name, descriptor)
	if field == nil || !field.IsStatic() {
		Fatal("Cannot find static variable %s %s in class %s", name, descriptor, class.name)
	}
...
func (this *API) CurrentTimeMillis() Long {
	return Long(time.Now().UnixNano() / int64(time.Millisecond))
}

func (this *API) CurrentTimeNano() Long {
	return Long(time.Now().UnixNano())
}

func (this *API) IHashCode(ref Reference) Int {
	if ref.IsNull() {
		return Int(0)
	}
...
func (this *API) Clone(obj Reference) Reference {
...
func (this *API) Throw(exception string, message string, args ...interface{})  {
	this.Throw0(VM.NewThrowable(exception, message, args...), THROWN_BY_VM)
}

func (this *API) StdoutPrintf(format string, args ...interface{})  {
	fmt.Fprintf(os.Stdout, format, args...)
}

func (this *API) StderrPrintf(format string, args ...interface{})  {
	fmt.Fprintf(os.Stderr, format, args...)
}

func (this *API) GetTypeClass(descriptor string) JavaLangClass {
